...
function Yeu() {
	...
	$("#divResult").html("</br><h2>AI CŨNG NÓI VẬY MÀ <img src='https://em-content.zobj.net/source/animated-noto-color-emoji/356/winking-face_1f609.gif'</img></h2>");
	$("#divResult").fadeIn(2000, function () {
		$("#divResult2").fadeOut(0);
		$("#divResult2").html("<p>♥ ỪA THÌ ANH BIẾT ANH ĐẸP TRAI THẬT. NHƯNG THÔI ANH CŨNG ĐÀNH CHỊU THIỆT THÍCH EM VẬY .</p></br>");
